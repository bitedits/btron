...
├── kernel/
│   └── index.html         # Sakamura T-Kernel 2.0 Real-Time OS Specification
├── cores/
│   └── index.html         # Real-Time Kernel, Lifecycle, Memory & SMP
├── graphics/
│   └── index.html         # Display Primitives (GDEV), ROP, Geometry & Clipping
├── tip/
│   └── index.html         # Text Input Primitives, IME (Mozc) & Multilingual TIP
├── vobject/
│   └── index.html         # Real Object (ROBJ) & Virtual Object (VOBJ_LINK) Fusen
├── window/
│   └── index.html         # Sakamura Window Manager (WND), Events & App Menus
├── desktop/
│   └── index.html         # Desktop Shell, Workbench, Tracker & Mobile UI
├── hmi/
│   └── index.html         # TRON Human-Machine Interface Component Subsystem
├── font/
│   └── index.html         # Multi-Script Typography & Font Management
├── settings/
│   └── index.html         # Control Panel & System Configuration Management
├── drivers/
│   └── index.html         # Hardware Abstraction Layer & VirtIO MMIO
└── apps/
    └── index.html         # Application Framework & Tier-1 Suite (gterm, t_editor)
```
