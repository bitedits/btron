...
def compile_foundational_books(target_dir: str = 'tad_bin'):
    btron3_elements = [
        ('h1', 'BTRON3 オペレーティングシステム仕様書 第3.20版'),
        ('image','b-spec/os_spec/shell/gif/title_bar.gif','図 1: BTRON3 標準タイトルバー意匠 (Title Bar Specification)'),
        ('link','b-spec/shared_data/data_type.tad','第1章 共有データ型・定数定義 (Shared Data Types)'),
        ('link','b-spec/kernel/itron.tad','第2章 μITRON 3.0 マイクロカーネルAPI仕様 (μITRON Kernel)'),
        ('link','b-spec/dp_graphics/dp.tad','第3章 DPグラフィックス・ライブラリ仕様 (DP Graphics Library)'),
        ('link','b-spec/os_spec/shell/shell.tad','第4章 シェル・標準GUI・ウィンドウマネージャ仕様 (Shell Spec)'),
        ('h2','BTRON3 設計哲学と標準化の理念'),
        ('p','「どこでもコンピュータ」構想に基づくユビキタス・リアルタイムOS標準。'
             'T-Engineプラットフォームと完全互換性を保ちながら、組み込みからデスクトップまで統一APIを提供する。'),
        ('h2','システム構成 (System Architecture)'),
        ('ul',['μITRON 3.0 マイクロカーネル (Real-Time Microkernel)',
               'T-Kernel 2.0 拡張サービス (Extended Services)',
               'BTRON3 デスクトップシェル (Desktop Shell)',
               'B-System POSIX/VirtIO ホスト型実装 (POSIX Host Layer)']),
    ]
    tkernel_elements = [
        ('h1','T-Kernel 2.0 リアルタイムOS仕様書'),
        ('link','t-kernel/index.tad','第1章 T-Kernel 2.0 アーキテクチャ概要 (Architecture Overview)'),
        ('link','t-kernel/task_management.tad','第2章 タスク管理機能 (Task Management)'),
        ('link','t-kernel/synchronization.tad','第3章 同期・通信機能 (Synchronization & IPC)'),
        ('link','t-kernel/memory_management.tad','第4章 メモリ管理機能 (Memory Management)'),
        ('link','t-kernel/interrupt_management.tad','第5章 割込み管理機能 (Interrupt Management)'),
        ('link','t-kernel/time_management.tad','第6章 時間管理機能 (Time Management)'),
        ('h2','T-Kernel 2.0 設計目標'),
        ('ol',['高いリアルタイム性能 (High Real-Time Performance)',
               '低メモリフットプリント (Low Memory Footprint)',
               'POSIX互換インタフェース (POSIX Compatible Interface)',
               'マルチコア対応 (Multi-Core Support)']),
    ]
    bfree_elements = [
        ('h1','B-Free オープンソース BTRON3 実装仕様書'),
