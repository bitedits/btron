//
//	ud_back.h (偽仮身一覧/取り消し動作-背景化)
//
//	(C) Copyright 2002 by Personal Media Corporation.
//

#ifndef	_I_DLED_UD_BACK_H
#define	_I_DLED_UD_BACK_H
