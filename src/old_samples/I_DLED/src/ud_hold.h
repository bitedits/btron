//
//	ud_hold.h (偽仮身一覧/取り消し動作-固定化)
//
//	(C) Copyright 2002 by Personal Media Corporation.
//

#ifndef	_I_DLED_UD_HOLD_H
#define	_I_DLED_UD_HOLD_H
