...
EXPORT	W	subnum = -1;		/* 見出しパネルの表示番号	*/
EXPORT	VP	tagpnl = NULL;		/* 見出しパネル操作用		*/
EXPORT	SUBPNL_DEF subpnl[MAX_SUBPNL];	/* 見出しパネル内の定義		*/
EXPORT	W	*subpid = NULL;		/* 見出しパネルのPID 配列	*/
EXPORT	W	act_box = -1;		/* アクティブなボックスパーツ	*/

EXPORT	SUBPNL_FN subfn[MAX_SUBPNL] = {	/* 見出しパネル処理関数テーブル	*/
		{page11_init, page11_disp, page11_act},
		{page12_init, page12_disp, page12_act},
		{page21_init, page21_disp, page21_act},
		{page31_init, page31_disp, page31_act}
	};
