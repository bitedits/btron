...
static void paint_input_settings(WND *wnd, GDEV *dev) {
    ...
    paint_ui_checkbox(dev, 18, 136, "Enable Hardware Key Repeat (Delay: 120ms, Rate: 55cps)", g_state_input.checks[3], FALSE);
    ...
    paint_ui_checkbox(dev, 18, 200, "Enable Natural Pointer Acceleration (1.5x - 5.0x Precision)", g_state_input.checks[4], FALSE);
